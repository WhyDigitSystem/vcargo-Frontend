...
export default function CommonTable({
  ...
  const handleAddRow = () => {
    ...
    onRowsChange([...rows, { id: generateId(), ...empty, _editing: true }]);
  };
        ...
        return (
          <div className="flex items-center justify-center">
            <input
              ...
              checked={!!val}
              onChange={(e) =>
                handleCellChange(rowIndex, col.key, e.target.checked, "checkbox")
              }
      ...
      case "number":
        return (
          <input
            ...
            onChange={(e) =>
              handleCellChange(rowIndex, col.key, e.target.value, "number")
            }
          />
        );
      ...
      case "textarea":
        return (
          <textarea
            ...
            placeholder={col.placeholder}
            onChange={(e) =>
              handleCellChange(rowIndex, col.key, e.target.value, "text")
            }
          />
        );
  ...
  return (
    <div
      className={`w-full border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 ${className}`}
    >
      {title && (
          ...
          <tbody>
            {rows.length === 0 ? (
              ...
              rows.map((row, rIdx) => (
                ...
                >
                  {/* Fixed: Added dark mode text color for index number */}
                  ...
                  {showDelete && (
                    <td className="px-3 py-2">
                      <button
                        ...
                        className="px-2 py-1 text-xs rounded-md bg-red-50 text-red-600 hover:bg-red-100 dark:bg-red-900/20 dark:text-red-300 dark:hover:bg-red-900/30"
                      >
                        Delete
                      </button>
                    </td>
