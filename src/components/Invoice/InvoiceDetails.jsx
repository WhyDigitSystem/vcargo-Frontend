...
const InvoiceDetails = ({
  ...
  const getTrips = async () => {
    ...
    try {
      const res = await tripAPI.getAllTrips(orgId);
  ...
  const handleViewInvoiceFile = () => {
    ...
    const hasFile =
      invoiceForm.invoiceFile || (editingId && invoiceForm.invoiceFileName);
  ...
  const handleDownloadInvoiceFile = () => {
    ...
    if (invoiceForm.invoiceFile) {
      ...
      alert(
        `Download functionality for existing file: ${invoiceForm.invoiceFileName}\nImplement API call to download from server.`,
      );
    }
  };
  ...
  const TDS_OPTIONS = [
    ...
    {
      label: "Section 194C: HUF/Individuals - 1%",
      value: "194C_I",
      percent: 1,
    },
    ...
    {
      label: "Section 194-I: Plant & Machinery - 2%",
      value: "194I_PM",
      percent: 2,
    },
            ...
            <div className="mt-2 space-y-1">
              {invoiceForm.invoiceFile ? (
                <p className="text-xs text-green-600 flex items-center gap-1">
                  ...
                  <span>
                    • {(invoiceForm.invoiceFile.size / 1024).toFixed(2)} KB
                  </span>
                </p>
                  ...
                  >
                    ...
                    <td className="px-3 py-2">
                      <input
                        ...
                        value={charge.amount}
                        onChange={(e) =>
                          updateChargeField(charge.id, "amount", e.target.value)
                        }
                        placeholder="0.00"
                        className="w-full bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-700 rounded-md px-2 py-1 text-sm text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-blue-500"
                      />
                    ...
                    <td className="px-3 py-2">
                      <input
                        ...
                        value={charge.remark}
                        onChange={(e) =>
                          updateChargeField(charge.id, "remark", e.target.value)
                        }
                    ...
                    <td className="px-3 py-2">
                      <select
                        value={charge.trip}
                        onChange={(e) =>
                          updateChargeField(charge.id, "trip", e.target.value)
                        }
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <InputField
                ...
                onChange={(e) =>
                  updateInvoiceForm("totalAmount", e.target.value)
                }
                step="0.01"
              />
              {errors.totalAmount && (
            ...
            <div>
              ...
              <InputField
                ...
                onChange={(e) =>
                  updateInvoiceForm("payableAmount", e.target.value)
                }
                step="0.01"
          ...
          <div className="space-y-4">
            <div>
              ...
              <InputField
                ...
                onChange={(e) =>
                  updateInvoiceForm("invoiceNumber", e.target.value)
                }
            ...
            <div>
              ...
              <InputField
                ...
                onChange={(e) =>
                  updateInvoiceForm("invoiceDate", e.target.value)
                }
              />
              {errors.invoiceDate && (
                <p className="text-xs text-red-500 mt-1">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                onChange={(e) =>
                  updateInvoiceForm("description", e.target.value)
                }
              ...
              {selectedInvoiceFile.url ? (
                ...
                <div className="text-center p-8">
                  <p className="text-gray-500 mb-2">
                    Existing invoice file on server
                  </p>
                  ...
                  <button
                    onClick={() => {
                      ...
                      alert(
                        `Download functionality for existing file: ${selectedInvoiceFile.name}\nImplement API call to download from server.`,
                      );
                    }}
