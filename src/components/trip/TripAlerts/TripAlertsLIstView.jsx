...
const TripAlertsListView = ({ setIsListView }) => {
    ...
    const mockData = [
        {
            ...
            type: "Switched Off",
            extra: "Battery Issue",
            fromDate: "2025-11-07 12:30 PM",
            toDate: "2025-11-07 01:00 PM",
        },
        {
            id: 2,
            trip: "Trip B",
            ...
            extra: "5 km deviation",
            fromDate: "2025-11-06 03:15 PM",
            toDate: "2025-11-06 03:45 PM",
        },
        {
            id: 3,
            trip: "Trip C",
            ...
            driver: "Sanjay",
            type: "Long Stoppage",
            extra: "Stopped 25 mins",
            fromDate: "2025-11-08 08:20 AM",
            toDate: "2025-11-08 08:50 AM",
        },
    ];
                ...
                <table className="min-w-full text-sm text-gray-700 dark:text-gray-300">
                    <thead className="bg-gray-100 dark:bg-gray-800 uppercase text-gray-600 dark:text-gray-300 text-xs">
                        <tr>
                            ...
                            <th className="px-5 py-3 text-left font-semibold">Driver</th>
                            <th className="px-5 py-3 text-left font-semibold">Type</th>
                            <th className="px-5 py-3 text-left font-semibold">Extra</th>
                    ...
                    <tbody>
                        {mockData.map((item, idx) => (
                            ...
                            >
                                ...
                                <td className="px-5 py-4">{item.driver}</td>

                                <td className="px-5 py-4">{item.type}</td>

                                <td className="px-5 py-4">{item.extra}</td>

                                <td className="px-5 py-4">{item.fromDate}</td>

                                <td className="px-5 py-4">{item.toDate}</td>
...
export default TripAlertsListView;
