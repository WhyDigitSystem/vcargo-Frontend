...
export default function TripGeofenceAlertsMaster({ setIsListView }) {
        ...
        <div className="max-w-6xl mx-auto mt-5 bg-white dark:bg-gray-900 shadow-xl rounded-xl border border-gray-200 dark:border-gray-700">
            ...
            <div className="p-6 space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    {/* Other Fields */}
                    <InputField label="Tag" name="tag" value={formData.tag} onChange={handleChange} required />
                    ...
                    <InputField label="Geofence" name="geofence" value={formData.geofence} onChange={handleChange} />
                    <div>
                        <InputField label="Timestamp" name="timeStamp" value={formData.timeStamp} onChange={handleChange} type="datetime-local" />
