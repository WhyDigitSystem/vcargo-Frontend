...
const TripExecutionDashboard = () => {
  ...
  const shortcuts = [
    { label: "Trip Dashboard", route: "/trip-dashboard" },
    { label: "Trip Report MIS", route: "/trip-report-mis" },
    { label: "Trip Analysis", route: "/trip-analysis" },
  ...
  const quickLinks = [
    {
      ...
      items: [
        ...
        { label: "Trip Reports", route: "/trip-report-mis", state: { openMaster: true } },
        { label: "Trip Analysis", route: "/trip-analysis" },
        { label: "Trip Geofence Alerts", route: "/trip-geofence-alerts" },
        { label: "Trip Alerts", route: "/trip-alerts" },
      ],
    },
    {
      category: "Vehicles",
      icon: Users,
      items: [
        { label: "Vehicle Type", route: "/vehicle-type" },
        { label: "Vehicle", route: "/vehicle" },
        { label: "Driver", route: "/driver" },
      ],
    },
    {
      category: "Config",
      icon: Settings,
      items: [
        { label: "Vehicle Type", route: "/vehicle-types" },
        { label: "Routes", route: "/route" },
      ],
    },
    {
      category: "Reports",
      icon: FileText,
      items: [
        { label: "Trip MIS Report", route: "/trip-mis" },
        { label: "Internal Tickets", route: "/tickets" },
      ],
    },
  ];
