  ...
  const quickLinks = [
    {
      ...
      icon: FileText,
      items: [
        { label: "RFQ List", route: "/rfq" },
        { label: "RFQ Response", route: "/rfq-response" },
      ],
    },
    {
      category: "Auctions",
      icon: BarChart3,
      items: [
        { label: "Auction List", route: "/auction-list" },
        { label: "Auction Report", route: "/auction-report" },
      ],
    },
    {
      category: "Config",
      ...
      items: [
        ...
        { label: "Vehicle Type", route: "/config/vehicle-type" },
      ],
    },
    {
      category: "Vendors",
      icon: Users,
      items: [
        { label: "Vendor List", route: "/vendor" },
        { label: "Tag List", route: "/tag-list" },
      ],
    },
  ];
